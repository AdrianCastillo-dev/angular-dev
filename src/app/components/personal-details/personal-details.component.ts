  ...
  constructor(private userService:UserService, private formBuilder:FormBuilder, private loginService:LoginService  ){
    this.userService.getUser(environment.userId).subscribe({
      next: (userData) => {
        ...
        this.registerForm.controls.firstname.setValue( userData.email);
        this.registerForm.controls.lastname.setValue( userData.name);
        this.registerForm.controls.country.setValue( userData.pass);
      },
      error: (errorData) => {
